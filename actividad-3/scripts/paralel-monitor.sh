...
time_interval=$1             # Segundo parámetro o 5 segundos
output_file=${2:-"cpu_and_memory_stats.csv"}   # Pone Nombre archivo o "cpu_stats.csv" por defecto
...
do
    ...
    echo "$((i + 1))"    
    LC_NUMERIC=C sleep $time_interval
done
